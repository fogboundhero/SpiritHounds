...
public class Enemy2 : MonoBehaviour {
    ...
    this variable is never used in code, why is it being initialized and does it have any use at all?
    */

    public Transform Target = null; // players transform / position 
	public float playerDistance; // keep track of player distance 
	public float rotationDamping; // rotation of enmey so he can face player when chasing him 
